...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://qianshuaiblog.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '人民万岁', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.qianshuai.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '钱帅, 钱帅博客, 钱帅的博客', // 网站关键词 英文逗号隔开
