...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '钱帅', // 您的昵称 例如 tangly1024
//  BIO: process.env.NEXT_PUBLIC_BIO || '人民万岁', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.qianshuai.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '钱帅, 博客，钱帅博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '京ICP备2022024716号-1', // 备案号 闽ICP备XXXXXX
